...
code_directory = 'C:/Users/admin/Documents/kde_code'
data_directory = 'D:/data/HMI/example'

import sys
sys.path.append(os.path.abspath(code_directory))
from kde_code import radialise, kde, slope
...
download = client.get(result, path=os.path.join(data_directory, 'decaying_region.fits'))
...
kde2data = kde.kde_plot(mymap, ax=None, extrasmooth=2)[0]
